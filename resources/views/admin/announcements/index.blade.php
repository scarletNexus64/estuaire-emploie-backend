...
@section('title', 'Annonces Push & Email')
    ...
    <div class="stat-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value" style="color: white;">{{ $totalUsers }}</div>
            </div>
    ...
    <div class="stat-card" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white;">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value" style="color: white;">{{ $totalCandidates }}</div>
            </div>
    ...
    <div class="stat-card" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white;">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value" style="color: white;">{{ $totalRecruiters }}</div>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select id="broadcast_target" name="target_group" class="form-control" required>
                                <option value="all">Tous les utilisateurs ({{ $totalUsers }})</option>
                                <option value="candidates">Candidats uniquement ({{ $totalCandidates }})</option>
                                <option value="recruiters">Recruteurs uniquement ({{ $totalRecruiters }})</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    singleForm.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('{{ route("admin.announcements.send-to-user") }}', {
                method: 'POST',
                headers: {
    ...
    broadcastForm.addEventListener('submit', async function(e) {
        ...
        // Get total count
        const countResponse = await fetch(`{{ route("admin.announcements.user-count") }}?target_group=${targetGroup}`);
        ...
        try {
            ...
            while (!completed) {
                ...
                const response = await fetch('{{ route("admin.announcements.send-to-all") }}', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                        'Accept': 'application/json',
