<div class="grid grid-cols-1 lg:grid-cols-2 gap-6" x-data="{
    selectedColumns: [],
    allColumns: [
        { key: 'title', label: 'Titre du poste' },
        { key: 'description', label: 'Description' },
        { key: 'requirements', label: 'Exigences' },
        { key: 'benefits', label: 'Avantages' },
        { key: 'salary_min', label: 'Salaire minimum' },
        { key: 'salary_max', label: 'Salaire maximum' },
        { key: 'salary_negotiable', label: 'Salaire négociable' },
        { key: 'experience_level', label: 'Niveau d\'expérience' },
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="flex flex-col sm:flex-row gap-2">
            <button @click="window.exportTemplate('jobs', selectedColumns, 'template')"
                    class="flex-1 btn btn-primary">
                <i class="fas fa-file-download"></i>
                Template (vide)
            </button>
            <button @click="window.exportTemplate('jobs', selectedColumns, 'data')"
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">
            <i class="fas fa-upload mr-2 text-green-600"></i>Importer des Jobs
        </h3>
        ...
        <div class="mb-6">
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-primary transition">
                <input type="file"
                       ...
                       accept=".csv,.xlsx,.xls"
                       class="hidden"
                       @change="window.importFile('jobs', $event.target)">
                <label for="jobs-import-file" class="cursor-pointer">
        ...
        <button @click="document.getElementById('jobs-import-file').click()"
