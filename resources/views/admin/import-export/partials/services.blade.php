<div class="grid grid-cols-1 lg:grid-cols-2 gap-6" x-data="{
    selectedColumns: [],
    allColumns: [
        { key: 'title', label: 'Titre du service' },
        { key: 'description', label: 'Description' },
        { key: 'price_type', label: 'Type de prix' },
        { key: 'price_min', label: 'Prix minimum' },
        { key: 'price_max', label: 'Prix maximum' },
        { key: 'location_name', label: 'Localisation' },
        { key: 'latitude', label: 'Latitude' },
        { key: 'longitude', label: 'Longitude' },
        { key: 'urgency', label: 'Urgence' },
        { key: 'desired_date', label: 'Date souhaitée' },
        { key: 'estimated_duration', label: 'Durée estimée' },
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="flex flex-col sm:flex-row gap-2">
            <button @click="window.exportTemplate('quick-services', selectedColumns, 'template')"
                    class="flex-1 btn btn-primary">
                <i class="fas fa-file-download"></i>
                Template (vide)
            </button>
            <button @click="window.exportTemplate('quick-services', selectedColumns, 'data')"
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">
            <i class="fas fa-upload mr-2 text-green-600"></i>Importer des Services Rapides
        </h3>
        ...
        <div class="mb-6">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <ol class="text-sm text-blue-700 list-decimal list-inside mt-2 space-y-1">
                            ...
                            <li>L'utilisateur (user_email) doit exister dans la base</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-primary transition">
                <input type="file"
                       ...
                       accept=".csv,.xlsx,.xls"
                       class="hidden"
                       @change="window.importFile('quick-services', $event.target)">
                <label for="services-import-file" class="cursor-pointer">
        ...
        <button @click="document.getElementById('services-import-file').click()"
