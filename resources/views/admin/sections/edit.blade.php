...
@section('page-title', 'Éditer la Section')
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Modifier {{ $section->name }}</h3>
    </div>
    ...
    <form method="POST" action="{{ route('admin.sections.update', $section) }}">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
            ...
            <div class="form-group">
                ...
                <input type="text" name="icon" class="form-control" value="{{ old('icon', $section->icon) }}" placeholder="📂">
        ...
        <div style="display: flex; gap: 1rem; padding-top: 1.5rem; border-top: 2px solid var(--light);">
            ...
            <a href="{{ route('admin.sections.show', $section) }}" class="btn btn-secondary">Annuler</a>
        </div>
    </form>
</div>
@endsection
