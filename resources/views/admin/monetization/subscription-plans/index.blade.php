...
@section('header-actions')
    <a href="{{ route('admin.subscription-plans.create') }}" class="header-btn">
            ...
            @foreach($plans as $plan)
                <div class="subscription-plan-card {{ $plan->is_popular ? 'popular' : '' }}" data-plan-id="{{ $plan->id }}">
                    ...
                    <div class="plan-actions">
                        <a href="{{ route('admin.subscription-plans.edit', $plan->id) }}" class="btn btn-sm" style="flex: 1; background: white; color: #667eea; border: 2px solid #667eea;">
                            <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                            Modifier
                        </a>
                        <form action="{{ route('admin.subscription-plans.destroy', $plan->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Supprimer ce plan ? Les abonnements actifs ne seront pas affectés.');">
                            @csrf
                            @method('DELETE')
