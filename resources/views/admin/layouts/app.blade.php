        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <div class="menu-section">
                    ...
                    <a href="{{ route('admin.recruiters.index') }}" class="menu-item {{ request()->routeIs('admin.recruiters.*') ? 'active' : '' }}">
                        <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="menu-section">
                    ...
                    <a href="{{ route('admin.subscription-plans.index') }}" class="menu-item {{ request()->routeIs('admin.subscription-plans.*') ? 'active' : '' }}">
                        <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.premium-services.index') }}" class="menu-item {{ request()->routeIs('admin.premium-services.*') ? 'active' : '' }}">
                        <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.addon-services.index') }}" class="menu-item {{ request()->routeIs('admin.addon-services.*') ? 'active' : '' }}">
                        <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.cvtheque.index') }}" class="menu-item {{ request()->routeIs('admin.cvtheque.*') ? 'active' : '' }}">
                        <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                        CVthèque
                    ...
                    <a href="{{ route('admin.advertisements.index') }}" class="menu-item {{ request()->routeIs('admin.advertisements.*') ? 'active' : '' }}">
                        <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.financial-stats.index') }}" class="menu-item {{ request()->routeIs('admin.financial-stats.*') ? 'active' : '' }}">
                        <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="menu-section">
                    ...
                    <a href="{{ route('admin.service-config.index') }}" class="menu-item {{ request()->routeIs('admin.service-config.*') ? 'active' : '' }}">
                        <svg class="menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
