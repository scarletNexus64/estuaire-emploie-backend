        ...
        <nav class="py-6 flex-1 overflow-y-auto custom-scrollbar">
            @php
                ...
                $iconMapping = [
                    ...
                    'fas fa-user-graduate' => 'mdi-school',
                    'fas fa-user-tie' => 'mdi-account-tie',
                    'fas fa-tools' => 'mdi-tools',
                    'fas fa-clipboard-check' => 'mdi-clipboard-check',
                    'fas fa-id-card' => 'mdi-card-account-details',
                    'fas fa-box' => 'mdi-package-variant',
                    'fas fa-graduation-cap' => 'mdi-school',
                    'fas fa-video' => 'mdi-video',
                    'fas fa-bullhorn' => 'mdi-bullhorn',
