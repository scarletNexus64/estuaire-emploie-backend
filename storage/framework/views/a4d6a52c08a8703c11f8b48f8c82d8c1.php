...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - Estuaire Emploi Admin</title>
    ...
    >
        ...
        <div class="bg-gradient-to-r from-primary to-tertiary px-6 py-5 border-b border-white/10 flex-shrink-0">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/logo-estuaire-emploi.png')); ?>" alt="Estuaire Emploi" class="w-12 h-12 brightness-0 invert">
                <div>
        ...
        <nav class="py-6 flex-1 overflow-y-auto custom-scrollbar">
            ...
            <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-6">
                    <div class="px-6 mb-2">
                        <h3 class="text-white/50 text-xs font-bold uppercase tracking-wider"><?php echo e($section['section']); ?></h3>
                    </div>
                    <?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e(isset($item['url']) ? $item['url'] : route($item['route'])); ?>"
                           class="flex items-center gap-3 px-6 py-3 mx-3 rounded-lg text-white/70 hover:text-white hover:bg-white/10 transition-all duration-200 group <?php echo e($isActive ? 'bg-gradient-to-r from-primary/20 to-tertiary/20 text-white border-l-4 border-primary ml-2' : ''); ?>"
                           <?php if(isset($item['external']) && $item['external']): ?> target="_blank" <?php endif; ?>>
                            <i class="mdi <?php echo e($mdiIcon); ?> text-xl <?php echo e($isActive ? 'text-primary' : ''); ?>"></i>
                            <span class="flex-1 font-medium text-sm"><?php echo e($item['name']); ?></span>

                            
                            <?php if(isset($item['route']) && $item['route'] === 'admin.applications.index' && isset($pendingApplications) && $pendingApplications > 0): ?>
                                <span class="bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full"><?php echo e($pendingApplications); ?></span>
                            <?php endif; ?>
                            ...
                            <?php if(isset($item['route']) && $item['route'] === 'admin.subscriptions.index' && class_exists('\App\Models\Subscription')): ?>
                                ...
                                <?php if($activeSubscriptions > 0): ?>
                                    <span class="bg-green-500 text-white text-xs font-bold px-2 py-0.5 rounded-full"><?php echo e($activeSubscriptions); ?></span>
                                <?php endif; ?>
                            <?php endif; ?>
        ...
        <div class="bg-gray-900/50 border-t border-white/10 p-4 flex-shrink-0">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-white/60 text-xs truncate"><?php echo e(auth()->user()->email ?? ''); ?></p>
                </div>
            </div>
        </div>
    </aside>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        >
                            ...
                            <a href="<?php echo e(route('admin.profile')); ?>" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="mdi mdi-account-circle text-lg"></i>
                                Mon profil
                            </a>

                            <a href="<?php echo e(route('admin.settings.index')); ?>" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
