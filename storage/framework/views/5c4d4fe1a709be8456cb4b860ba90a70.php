...
<div class="card">
                ...
                <tr>
                    ...
                    <td>
                        <?php if($admin->isSuperAdmin()): ?>
                            <span class="badge badge-primary" style="font-size: 0.8125rem;">⭐ Super Administrateur</span>
                        <?php elseif($admin->admin_role): ?>
                            <span class="badge badge-info" style="font-size: 0.8125rem;"><?php echo e($admin->admin_role->label()); ?></span>
                        <?php else: ?>
                            <span class="badge badge-secondary" style="font-size: 0.8125rem;">Administrateur</span>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php if($admin->isSuperAdmin()): ?>
    ...
    <div style="padding: 1.5rem; border-top: 2px solid var(--light);">
        <?php echo e($admins->links('vendor.pagination.custom')); ?>
...
<script>
    ...
    deleteBtn?.addEventListener('click', function() {
        ...
        if (!confirm(`Supprimer ${selected.length} administrateur(s) sélectionné(s) ?\n\nCette action est irréversible.`)) {
            return;
        }
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/clients/client1/web19/web/estuaire-emploie-backend/resources/views/admin/admins/index.blade.php ENDPATH**/ ?>