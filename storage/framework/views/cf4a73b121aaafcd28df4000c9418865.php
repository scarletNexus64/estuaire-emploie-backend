<?php $__env->startSection('title', 'Éditer Administrateur'); ?>
<?php $__env->startSection('page-title', 'Éditer l\'Administrateur'); ?>
...
<?php $__env->startSection('header-actions'); ?>
    <a href="<?php echo e(route('admin.admins.show', $user)); ?>" class="btn btn-secondary">
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Modifier <?php echo e($user->name); ?></h3>
    </div>

    <form method="POST" action="<?php echo e(route('admin.admins.update', $user)); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            <div style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.1), rgba(118, 75, 162, 0.1)); padding: 1.5rem; border-radius: 12px; border-left: 4px solid var(--primary);">
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    <input type="checkbox" name="is_super_admin" value="1" id="is_super_admin" <?php echo e(old('is_super_admin', $user->is_super_admin) ? 'checked' : ''); ?> style="width: 20px; height: 20px; cursor: pointer; accent-color: var(--primary);">
                        ...
                        <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                <input type="checkbox"
                                       ...
                                       <?php echo e(in_array($key, old('permissions', $user->permissions ?? [])) ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="display: flex; gap: 1rem; padding-top: 1.5rem; border-top: 2px solid var(--light);">
            ...
            <a href="<?php echo e(route('admin.admins.show', $user)); ?>" class="btn btn-secondary">Annuler</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/clients/client1/web19/web/estuaire-emploie-backend/resources/views/admin/admins/edit.blade.php ENDPATH**/ ?>