...
<?php $__env->startSection('breadcrumbs'); ?>
    <span>/ Monétisation / Plans Recruteurs</span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('header-actions'); ?>
    <a href="<?php echo e(route('admin.subscription-plans.recruiters.create')); ?>" class="header-btn">
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Plans d'Abonnement Recruteurs Configurables</h3>
    ...
    <?php if($plans->isEmpty()): ?>
        <div style="text-align: center; padding: 4rem 2rem;">
            ...
            <a href="<?php echo e(route('admin.subscription-plans.recruiters.create')); ?>" class="btn btn-primary">
            ...
            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="subscription-plan-card <?php echo e($plan->is_popular ? 'popular' : ''); ?>" data-plan-id="<?php echo e($plan->id); ?>">
                    ...
                    <div class="plan-actions">
                        <a href="<?php echo e(route('admin.subscription-plans.recruiters.edit', $plan->id)); ?>" class="btn btn-sm" style="flex: 1; background: white; color: #667eea; border: 2px solid #667eea;">
                            <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                            Modifier
                        </a>
                        <form action="<?php echo e(route('admin.subscription-plans.recruiters.destroy', $plan->id)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('Supprimer ce plan ? Les abonnements actifs ne seront pas affectés.');">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookpro/Desktop/Developments/INSAM-DEV/E-Emploie-Backend/estuaire-emploie-backend/resources/views/admin/monetization/subscription-plans-recruiters/index.blade.php ENDPATH**/ ?>