...
<div class="row">
        ...
        <div class="card">
            <div class="card-header" style="display: flex; align-items: center; gap: 1rem;">
                <?php if($portfolio->photo_url): ?>
                    <img src="<?php echo e($portfolio->photo_url); ?>" alt="Photo" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover;">
                <?php else: ?>
                ...
                <?php endif; ?>
                <div style="flex: 1;">
                    <h5 class="card-title mb-1"><?php echo e($portfolio->title); ?></h5>
                    <div class="mb-2">
                        <strong><?php echo e($portfolio->user->name); ?></strong>
                        <span class="text-muted">• <?php echo e($portfolio->user->email); ?></span>
                    </div>
                    <div style="display: flex; gap: 0.5rem; align-items: center;">
                        <span class="badge badge-<?php echo e(['professional' => 'info', 'creative' => 'warning', 'tech' => 'success'][$portfolio->template_id] ?? 'secondary'); ?>">
            ...
            <div style="padding: 1.5rem;">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-muted"><?php echo e($portfolio->bio); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <strong>Slug:</strong>
                            <div><code><?php echo e($portfolio->slug); ?></code></div>
                        </div>
                        <div class="mb-3">
                            <strong>URL Publique:</strong>
                            <div><a href="<?php echo e($portfolio->public_url); ?>" target="_blank"><?php echo e($portfolio->public_url); ?></a></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                <div style="width: 30px; height: 30px; border-radius: 4px; background: <?php echo e($portfolio->theme_color); ?>; border: 2px solid var(--border);"></div>
                        ...
                        <div class="mb-3">
                            <strong>CV:</strong>
                            <div><a href="<?php echo e($portfolio->cv_url); ?>" target="_blank">Télécharger le CV</a></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    <h6 style="font-weight: 700; margin-bottom: 0.75rem;">Compétences (<?php echo e(count($portfolio->skills)); ?>)</h6>
                    <div style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
                        ...
                        <span class="badge badge-info"><?php echo e($skill['name']); ?> - <?php echo e($skill['level']); ?></span>
                ...
                <div class="mb-4">
                    <h6 style="font-weight: 700; margin-bottom: 0.75rem;">Expériences (<?php echo e(count($portfolio->experiences)); ?>)</h6>
                    ...
                    <div class="card mb-2" style="padding: 1rem; background: var(--light);">
                        <strong><?php echo e($exp['title']); ?></strong>
                        <div class="text-muted small"><?php echo e($exp['company']); ?> • <?php echo e($exp['duration']); ?></div>
                        <?php if(isset($exp['description'])): ?>
                        <div class="mt-2"><?php echo e($exp['description']); ?></div>
                        <?php endif; ?>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="mb-4">
                    <h6 style="font-weight: 700; margin-bottom: 0.75rem;">Formation (<?php echo e(count($portfolio->education)); ?>)</h6>
                    ...
                    <div class="card mb-2" style="padding: 1rem; background: var(--light);">
                        <strong><?php echo e($edu['degree']); ?></strong>
                        <div class="text-muted small"><?php echo e($edu['school']); ?> • <?php echo e($edu['year']); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php endif; ?>
                ...
                <div class="mb-4">
                    <h6 style="font-weight: 700; margin-bottom: 0.75rem;">Projets (<?php echo e(count($portfolio->projects)); ?>)</h6>
                    ...
                    <div class="card mb-2" style="padding: 1rem; background: var(--light);">
                        ...
                        <div class="mt-2"><?php echo e($project['description']); ?></div>
                        <?php if(isset($project['url'])): ?>
                        <div class="mt-2"><a href="<?php echo e($project['url']); ?>" target="_blank">Voir le projet</a></div>
                        <?php endif; ?>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                        ...
                        <?php if($url): ?>
                        <a href="<?php echo e($url); ?>" target="_blank" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($view->viewed_at->format('d/m/Y H:i')); ?></td>
                            <td>
                                <?php if($view->viewer): ?>
                                    <strong><?php echo e($view->viewer->name); ?></strong>
                                    <div class="small text-muted"><?php echo e($view->viewer->email); ?></div>
                                <?php else: ?>
                                    <span class="text-muted">Visiteur anonyme</span>
                                <?php endif; ?>
                            </td>
                            <td><code><?php echo e($view->viewer_ip ?? '-'); ?></code></td>
                            <td>
                                <?php if($view->referer): ?>
                                    <a href="<?php echo e($view->referer); ?>" target="_blank" class="small"><?php echo e(Str::limit($view->referer, 40)); ?></a>
                                <?php else: ?>
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div style="padding: 1.5rem;">
                <div class="mb-3">
                    ...
                    <div class="stat-value" style="font-size: 2rem;"><?php echo e(number_format($portfolio->view_count)); ?></div>
                </div>
                <div class="mb-3">
                    <div class="stat-label">Vues (7 derniers jours)</div>
                    <div class="stat-value" style="font-size: 2rem;"><?php echo e($portfolio->getViewsInLastDays(7)); ?></div>
                </div>
                <div class="mb-3">
                    <div class="stat-label">Vues (30 derniers jours)</div>
                    <div class="stat-value" style="font-size: 2rem;"><?php echo e($portfolio->getViewsInLastDays(30)); ?></div>
                </div>
                <div class="mb-3">
                    <div class="stat-label">Visiteurs Uniques</div>
                    <div class="stat-value" style="font-size: 2rem;"><?php echo e($portfolio->getUniqueViewersCount()); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div style="padding: 1.5rem;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem;">
                    <span><?php echo e(\Carbon\Carbon::parse($stat->date)->format('d/m/Y')); ?></span>
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        <div style="width: 100px; height: 8px; background: var(--light); border-radius: 4px; overflow: hidden;">
                            <div style="width: <?php echo e(min(100, ($stat->count / max($viewsByDay->max('count'), 1)) * 100)); ?>%; height: 100%; background: var(--primary);"></div>
                        </div>
        ...
        <div class="card">
            ...
            <div style="padding: 1.5rem;">
                <div class="mb-3">
                    ...
                    <div class="text-muted"><?php echo e($portfolio->created_at->format('d/m/Y à H:i')); ?></div>
                </div>
                <div class="mb-3">
                    <strong>Modifié le :</strong>
                    <div class="text-muted"><?php echo e($portfolio->updated_at->format('d/m/Y à H:i')); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div style="padding: 1.5rem;">
                <a href="<?php echo e($portfolio->public_url); ?>" target="_blank" class="btn btn-primary mb-2" style="width: 100%;">
                    <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                    </svg>
                    Voir le Portfolio
                ...
                <form method="POST" action="<?php echo e(route('admin.portfolios.toggle-visibility', $portfolio)); ?>" class="mb-2">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookpro/Desktop/Developments/INSAM-DEV/E-Emploie-Backend/estuaire-emploie-backend/resources/views/admin/portfolios/show.blade.php ENDPATH**/ ?>