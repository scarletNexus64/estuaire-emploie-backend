<?php $__env->startSection('title', 'Services Premium'); ?>
<?php $__env->startSection('page-title', 'Services Premium Candidats'); ?>
...
<?php $__env->startSection('header-actions'); ?>
    <a href="<?php echo e(route('admin.premium-services.create')); ?>" class="header-btn">
...
<div class="card">
    ...
    <?php if($services->isEmpty()): ?>
        <div style="text-align: center; padding: 4rem 2rem;">
            ...
            <a href="<?php echo e(route('admin.premium-services.create')); ?>" class="btn btn-primary">
                ...
                <tbody>
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <?php if($service->userServices->count() == 0): ?>
                                    <span style="color: #94a3b8;">Aucun achat</span>
                                <?php endif; ?>
                                <strong><?php echo e($service->userServices->count()); ?></strong>
                            </td>

                            <td>
                                <div style="display: flex; gap: 0.5rem;">
                                    <a href="<?php echo e(route('admin.premium-services.edit', $service->id)); ?>" class="btn btn-sm btn-primary">
                                        <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                        </svg>
                                    </a>
                                    <form action="<?php echo e(route('admin.premium-services.toggle', $service->id)); ?>" method="POST" style="display: inline;">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <form action="<?php echo e(route('admin.premium-services.destroy', $service->id)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('Supprimer ce service ?');">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookpro/Desktop/Developments/INSAM-DEV/E-Emploie-Backend/estuaire-emploie-backend/resources/views/admin/monetization/premium-services/index.blade.php ENDPATH**/ ?>