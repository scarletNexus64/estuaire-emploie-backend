...
<?php $__env->startSection('page-title', 'Gestion des Programmes'); ?>
    ...
    <div class="stat-card">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value"><?php echo e($programs->count()); ?></div>
            </div>
    ...
    <div class="stat-card success">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value"><?php echo e($programs->where('is_active', true)->count()); ?></div>
            </div>
            <div class="stat-icon">✓</div>
        </div>
    </div>
    ...
    <div class="stat-card warning">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value"><?php echo e($programs->where('is_active', false)->count()); ?></div>
            </div>
            <div class="stat-icon">⏸</div>
        </div>
    </div>
    ...
    <div class="stat-card info">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value"><?php echo e($programs->sum('steps_count')); ?></div>
            </div>
            <div class="stat-icon">📝</div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div style="padding: 1rem;">
                <div style="font-size: 2rem; font-weight: bold; color: var(--primary);">
                    <?php echo e($programs->where('type', 'immersion_professionnelle')->count()); ?>
        ...
        <div class="card">
            ...
            <div style="padding: 1rem;">
                <div style="font-size: 2rem; font-weight: bold; color: var(--success);">
                    <?php echo e($programs->where('type', 'entreprenariat')->count()); ?>
        ...
        <div class="card">
            ...
            <div style="padding: 1rem;">
                <div style="font-size: 2rem; font-weight: bold; color: var(--info);">
                    <?php echo e($programs->where('type', 'transformation_professionnelle')->count()); ?>
                ...
                <tr>
                    <td>
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <div style="font-size: 2rem;"><?php echo e($program->icon); ?></div>
                            <div>
                                <strong><?php echo e($program->title); ?></strong>
                                <div class="small text-muted"><?php echo e(Str::limit($program->description, 60)); ?></div>
                            </div>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php if($program->duration_weeks): ?>
                            <span class="badge badge-info"><?php echo e($program->duration_weeks); ?> semaines</span>
                        <?php else: ?>
                            <span class="text-muted">-</span>
                        <?php endif; ?>
                    </td>
                    <td>
                        <span class="badge badge-secondary"><?php echo e($program->steps_count); ?> étape(s)</span>
                    </td>
                    <td>
                        <span class="badge badge-info"><?php echo e($program->order); ?></span>
                    </td>
                    <td>
                    ...
                    <td>
                        <div style="display: flex; gap: 0.5rem;">
                            <a href="<?php echo e(route('admin.programs.show', $program)); ?>" class="btn btn-sm btn-info" title="Voir">
                            ...
                            <a href="<?php echo e(route('admin.programs.manage-steps', $program)); ?>" class="btn btn-sm btn-primary" title="Gérer les étapes">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                                </svg>
                            </a>

                            <a href="<?php echo e(route('admin.programs.edit', $program)); ?>" class="btn btn-sm btn-secondary" title="Modifier">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                            </a>

                            <form method="POST" action="<?php echo e(route('admin.programs.destroy', $program)); ?>" style="display: inline;">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookpro/Desktop/Developments/INSAM-DEV/E-Emploie-Backend/estuaire-emploie-backend/resources/views/admin/programs/index.blade.php ENDPATH**/ ?>