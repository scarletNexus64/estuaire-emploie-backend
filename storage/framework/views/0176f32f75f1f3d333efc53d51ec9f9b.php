    ...
    <div class="stat-card" style="border-left: 4px solid #8b5cf6;">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value"><?php echo e($stats['total_notifications'] ?? 0); ?></div>
            </div>
            <div class="stat-icon">🔔</div>
        </div>
        <div class="stat-footer">
            <span class="stat-trend" style="color: #8b5cf6;">
                <?php echo e($stats['unread_notifications'] ?? 0); ?> non lues
            </span>
        </div>
    </div>
</div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/djstar-service/Documents/Project/My_project/EstuaireEmploieProd/estuaire-emploie-backend/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>