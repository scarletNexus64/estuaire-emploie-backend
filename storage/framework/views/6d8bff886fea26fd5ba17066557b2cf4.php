...
<?php $__env->startSection('header-actions'); ?>
    ...
    <a href="<?php echo e(route('admin.admins.edit', $user)); ?>" class="btn btn-primary">
...
<div style="display: grid; grid-template-columns: 1fr 2fr; gap: 1.5rem;">
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem; text-align: left;">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                        ...
                        <div>
                            ...
                            <strong><?php echo e($user->last_login_at->diffForHumans()); ?></strong>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
    ...
    <div class="card">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem;">
            ...
            <?php $__currentLoopData = $allPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="padding: 1rem; background: var(--light); border-radius: 8px; display: flex; align-items: center; gap: 12px;">
                <div style="font-size: 1.5rem;"><?php echo e($data['icon']); ?></div>
                <div style="flex: 1;">
                    <strong style="display: block; margin-bottom: 0.25rem;"><?php echo e($data['label']); ?></strong>
                    <?php if(in_array($perm, $user->permissions ?? [])): ?>
        ...
        <?php if(!$user->permissions || count($user->permissions) === 0): ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/clients/client1/web19/web/estuaire-emploie-backend/resources/views/admin/admins/show.blade.php ENDPATH**/ ?>