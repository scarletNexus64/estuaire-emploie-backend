<?php $__env->startSection('title', 'Configuration des Services'); ?>
...
<div class="container-fluid">
    ...
    <?php if(session('warning')): ?>
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <i class="mdi mdi-alert me-2"></i><?php echo e(session('warning')); ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <form action="<?php echo e(route('admin.service-config.clear-cache')); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3" id="serviceConfigTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="payment-tab" data-bs-toggle="tab" href="#payment" role="tab" aria-controls="payment" aria-selected="false">
                                ...
                                <?php if($freemopayConfig && $freemopayConfig->isConfigured()): ?>
                                    <span class="badge bg-success ms-1">Configuré</span>
                                <?php else: ?>
                                    <span class="badge bg-warning ms-1">Non configuré</span>
                                <?php endif; ?>
                    ...
                    <div class="tab-content" id="serviceConfigTabsContent">
                        ...
                        <?php echo $__env->make('admin.service-config.whatsapp', ['config' => $whatsappConfig], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                        
                        <?php echo $__env->make('admin.service-config.nexah', ['config' => $nexahConfig], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<script>
    ...
    function sendWhatsAppTest() {
        ...
        fetch('<?php echo e(route("admin.service-config.send-test-whatsapp")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
    ...
    function sendNexahTest() {
        ...
        fetch('<?php echo e(route("admin.service-config.send-test-nexah")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json',
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookpro/Desktop/Developments/INSAM-DEV/E-Emploie-Backend/estuaire-emploie-backend/resources/views/admin/service-config/index.blade.php ENDPATH**/ ?>