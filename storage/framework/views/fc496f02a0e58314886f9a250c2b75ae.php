<?php $__env->startSection('title', 'Compte FREEMOPAY'); ?>
<?php $__env->startSection('page-title', 'Compte FREEMOPAY - Revenus & Retraits'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(450px, 1fr)); gap: 2rem; margin-bottom: 2rem;">
        ...
        <div class="card">
            <div style="padding: 2rem; text-align: center; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); border-radius: 16px;">
                ...
                <h1 style="color: white; font-size: 2.5rem; font-weight: 800; margin: 0;">
                    <?php echo e(number_format($freemopayAvailableBalance, 0, ',', ' ')); ?>
                ...
                <div style="display: flex; justify-content: center; gap: 2rem; margin-top: 1rem; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.2);">
                    <div>
                        ...
                        <p style="color: white; font-size: 1rem; font-weight: 700; margin: 0.25rem 0 0 0;">
                            <?php echo e(number_format($freemopayRevenue, 0, ',', ' ')); ?>
                    ...
                    <div>
                        ...
                        <p style="color: white; font-size: 1rem; font-weight: 700; margin: 0.25rem 0 0 0;">
                            <?php echo e(number_format($freemopayWithdrawn, 0, ',', ' ')); ?>
        ...
        <div class="card">
            <div style="padding: 2rem; text-align: center; background: linear-gradient(135deg, #0070ba 0%, #003087 100%); border-radius: 16px;">
                ...
                <h1 style="color: white; font-size: 2.5rem; font-weight: 800; margin: 0;">
                    <?php echo e(number_format($paypalAvailableBalance, 2, '.', ',')); ?>
                ...
                <div style="display: flex; justify-content: center; gap: 2rem; margin-top: 1rem; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.2);">
                    <div>
                        <p style="color: rgba(255,255,255,0.8); font-size: 0.8rem; margin: 0;">Revenus</p>
                        <p style="color: white; font-size: 1rem; font-weight: 700; margin: 0.25rem 0 0 0;">
                            <?php echo e(number_format($paypalRevenue, 2, '.', ',')); ?>
                    ...
                    <div>
                        <p style="color: rgba(255,255,255,0.8); font-size: 0.8rem; margin: 0;">Retiré</p>
                        <p style="color: white; font-size: 1rem; font-weight: 700; margin: 0.25rem 0 0 0;">
                            <?php echo e(number_format($paypalWithdrawn, 2, '.', ',')); ?>
    ...
    <div class="card">
        ...
        <div style="display: flex; border-bottom: 2px solid #e2e8f0; background: #f8fafc;">
            ...
            >
                ...
                Revenus Plateforme
                <span class="badge badge-success" style="margin-left: 0.5rem;"><?php echo e($revenues->total()); ?></span>
            </button>
            <button
                class="tab-button"
                data-tab="retraits"
            ...
            >
                ...
                Historique Retraits
                <span class="badge badge-danger" style="margin-left: 0.5rem;"><?php echo e($withdrawals->total()); ?></span>
            </button>
        </div>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div style="display: flex; align-items: center; gap: 12px;">
                            ...
                            <div>
                                ...
                                <p style="margin: 0; opacity: 0.9; font-size: 0.875rem;"><?php echo e($revenues->total()); ?> revenu(s) enregistré(s)</p>
                            </div>
                        </div>
                        <div style="text-align: right;">
                            <p style="margin: 0; opacity: 0.8; font-size: 0.875rem;">Total Revenus</p>
                            <h3 style="margin: 0; color: white; font-weight: 700;"><?php echo e(number_format($totalRevenue, 0, ',', ' ')); ?> XAF</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong>#<?php echo e($revenue['id']); ?></strong></td>
                                <td>
                                    <span class="badge badge-success" style="font-size: 0.875rem; padding: 0.5rem 1rem;">
                                        <?php echo e(number_format($revenue['amount'], 0, ',', ' ')); ?> XAF
                                    </span>
                                </td>
                                <td>
                                    <span class="badge badge-info"><?php echo e(ucfirst(str_replace('_', ' ', $revenue['payment_type'] ?? 'N/A'))); ?></span>
                                </td>
                                <td>
                                    <?php if($revenue['provider'] === 'paypal'): ?>
                                        <span style="color: #0070ba; font-weight: 600;">
                                            <i class="fab fa-paypal"></i> PayPal
                                        </span>
                                    <?php elseif($revenue['provider'] === 'freemopay'): ?>
                                        <span style="color: #f59e0b; font-weight: 600;">
                                            <i class="fas fa-mobile-alt"></i> FreeMoPay
                                        </span>
                                    <?php else: ?>
                                        <span style="color: #6c757d;"><?php echo e($revenue['provider']); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($revenue['payment_method'] === 'mtn_money'): ?>
                                        <span style="color: #FFB300;"><i class="fas fa-mobile-alt"></i> MTN</span>
                                    <?php elseif($revenue['payment_method'] === 'orange_money'): ?>
                                        <span style="color: #FF6600;"><i class="fas fa-mobile-alt"></i> Orange</span>
                                    <?php elseif($revenue['payment_method'] === 'paypal'): ?>
                                        <span style="color: #0070ba;"><i class="fab fa-paypal"></i> PayPal</span>
                                    <?php else: ?>
                                        <span style="color: #6c757d;"><?php echo e(ucfirst($revenue['payment_method'] ?? 'N/A')); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($revenue['transaction_reference']): ?>
                                        <code style="font-size: 0.75rem; color: #6c757d;"><?php echo e(Str::limit($revenue['transaction_reference'], 20)); ?></code>
                                    <?php else: ?>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div style="display: flex; align-items: center; gap: 12px;">
                            ...
                            <div>
                                ...
                                <p style="margin: 0; opacity: 0.9; font-size: 0.875rem;"><?php echo e($withdrawals->total()); ?> retrait(s) enregistré(s)</p>
                            </div>
                        </div>
                        <div style="display: flex; align-items: center; gap: 1.5rem;">
                            <div style="text-align: right;">
                                <p style="margin: 0; opacity: 0.8; font-size: 0.875rem;">Total Retiré</p>
                                <h3 style="margin: 0; color: white; font-weight: 700;"><?php echo e(number_format($totalWithdrawn, 0, ',', ' ')); ?> XAF</h3>
                            </div>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong>#<?php echo e($withdrawal['id']); ?></strong></td>
                                <td>
                                    <span class="badge badge-danger" style="font-size: 0.875rem; padding: 0.5rem 1rem;">
                                        - <?php echo e(number_format($withdrawal['amount'], 0, ',', ' ')); ?> XAF
                                    </span>
                                </td>
                                <td>
                                    <span class="badge <?php echo e($withdrawal['status_badge']['class']); ?>">
                                        <?php echo e($withdrawal['status_badge']['label']); ?>

                                    </span>
                                </td>
                                <td>
                                    <?php if($withdrawal['payment_method'] === 'momo'): ?>
                                ...
                                <td>
                                    <code style="font-size: 0.875rem;"><?php echo e($withdrawal['payment_account']); ?></code>
                                </td>
                                <td>
                                    <i class="fas fa-user-shield" style="color: #dc3545; margin-right: 0.5rem;"></i>
                                    <?php echo e($withdrawal['admin_name']); ?>

                                </td>
                                <td>
                                    <?php if($withdrawal['freemopay_reference']): ?>
                                        <code style="color: #dc3545; font-size: 0.75rem;"><?php echo e(Str::limit($withdrawal['freemopay_reference'], 20)); ?></code>
                                    <?php else: ?>
                                        <span style="color: #6c757d;">-</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($withdrawal['admin_notes']): ?>
                                        <span style="font-size: 0.875rem;" title="<?php echo e($withdrawal['admin_notes']); ?>">
                                            <?php echo e(Str::limit($withdrawal['admin_notes'], 30)); ?>
                                ...
                                <td>
                                    ...
                                    <?php if($withdrawal['completed_at']): ?>
                                        <br><small style="color: #28a745;">✓ <?php echo e($withdrawal['completed_at']); ?></small>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        ...
        function verifyPin() {
            ...
            fetch('<?php echo e(route('admin.bank-account.verify-pin')); ?>', {
                method: 'POST',
                headers: {
        ...
        function showWithdrawalForm(provider) {
            if (provider === 'paypal') {
                ...
                fetch('<?php echo e(route('admin.bank-account.paypal-available-balance')); ?>')
                    .then(response => response.json())
                    .then(data => {
                        if (data.success) {
                ...
                fetch('<?php echo e(route('admin.bank-account.available-balance')); ?>')
                    .then(response => response.json())
                    .then(data => {
                        if (data.success) {
        ...
        document.getElementById('withdrawalForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route('admin.bank-account.initiate-withdrawal')); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
        ...
        document.getElementById('paypalWithdrawalForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route('admin.bank-account.initiate-paypal-withdrawal')); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/clients/client1/web19/web/estuaire-emploie-backend/resources/views/admin/bank-account/index.blade.php ENDPATH**/ ?>