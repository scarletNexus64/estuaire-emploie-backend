<?php $__env->startSection('title', 'Effectuer un Retrait'); ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0"><?php echo e(number_format($available_balance, 0, ',', ' ')); ?> FCFA</h2>
                        </div>
                        <div class="fs-1">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-lg">
                                <input type="number"
                                       ...
                                       name="amount"
                                       min="50"
                                       max="<?php echo e($available_balance); ?>"
                                       step="10"
...
<div id="successModal" class="custom-modal" style="display: none;">
    ...
    <div class="modal-box">
        <div style="text-align: center; padding: 3rem 2rem;">
            ...
            <a href="<?php echo e(route('admin.bank-account.index')); ?>" class="btn btn-primary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.bank-account.initiate-withdrawal")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/clients/client1/web19/web/estuaire-emploie-backend/resources/views/admin/bank-account/withdrawal-form.blade.php ENDPATH**/ ?>