    ...
    <div class="stat-card info">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value"><?php echo e($stats['candidates']); ?></div>
            </div>
            <div class="stat-icon">👤</div>
        </div>
    </div>
    ...
    <div class="stat-card warning">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value"><?php echo e($stats['recruiters']); ?></div>
            </div>
            <div class="stat-icon">💼</div>
        </div>
    </div>
    ...
    <div class="stat-card danger">
        <div class="stat-header">
            <div>
                ...
                <div class="stat-value"><?php echo e($stats['active_today']); ?></div>
            </div>
            <div class="stat-icon">🟢</div>
        </div>
    </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr auto; gap: 1rem; align-items: end;">
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <select name="status" class="form-control">
                    ...
                    <option value="looking" <?php echo e(request('status') === 'looking' ? 'selected' : ''); ?>>En recherche</option>
                    <option value="employed" <?php echo e(request('status') === 'employed' ? 'selected' : ''); ?>>Employé</option>
                </select>
            </div>
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <select name="experience" class="form-control">
                    <option value="">Tous</option>
                    <option value="junior" <?php echo e(request('experience') === 'junior' ? 'selected' : ''); ?>>Junior</option>
                    <option value="intermediate" <?php echo e(request('experience') === 'intermediate' ? 'selected' : ''); ?>>Intermédiaire</option>
                    <option value="senior" <?php echo e(request('experience') === 'senior' ? 'selected' : ''); ?>>Senior</option>
                </select>
            </div>
            ...
            <div style="display: flex; gap: 0.5rem;">
                ...
                <?php if(request()->hasAny(['search', 'role', 'status', 'experience'])): ?>
                ...
                <tr>
                        ...
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <?php if($user->profile_photo): ?>
                                <img src="<?php echo e(asset('storage/' . $user->profile_photo)); ?>"
                                     alt="Photo <?php echo e($user->name); ?>"
                                     style="width: 48px; height: 48px; border-radius: 50%; object-fit: cover; border: 2px solid #e5e7eb;"
                                     onerror="this.onerror=null; this.outerHTML='<div style=\'width: 48px; height: 48px; border-radius: 50%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1.25rem;\'><?php echo e(strtoupper(substr($user->name, 0, 1))); ?></div>';">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <div>
                                <strong style="display: block;"><?php echo e($user->name); ?></strong>
                                <small style="color: var(--secondary); display: block;"><?php echo e($user->email ?? 'Pas d\'email'); ?></small>
                            </div>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php if($user->experience_level): ?>
                            <?php if($user->experience_level === 'junior'): ?>
                                <span class="badge badge-info">Junior</span>
                            <?php elseif($user->experience_level === 'intermediate'): ?>
                                <span class="badge badge-warning">Intermédiaire</span>
                            <?php elseif($user->experience_level === 'senior'): ?>
                                <span class="badge badge-success">Senior</span>
                            <?php else: ?>
                                <span class="badge badge-secondary"><?php echo e(ucfirst($user->experience_level)); ?></span>
                            <?php endif; ?>
                        <?php else: ?>
                    ...
                    <td>
                        <?php if($user->role === 'candidate'): ?>
                            <strong><?php echo e($user->applications_count); ?></strong>
                        <?php else: ?>
                    ...
                    <td>
                        <?php if($user->role === 'candidate'): ?>
                            <?php echo e($user->visibility_score ?? 0); ?>/100
                        <?php else: ?>
                            <span style="color: var(--secondary);">-</span>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php if($user->last_login_at): ?>
                            <span title="<?php echo e($user->last_login_at->format('d/m/Y H:i')); ?>">
                    ...
                    <td>
                        <div style="display: flex; gap: 0.5rem;">
                            <a href="<?php echo e(route('admin.users.show', $user)); ?>" class="btn btn-sm btn-primary" title="Voir">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="btn btn-sm btn-warning" title="Modifier">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
