...
<?php $__env->startSection('breadcrumbs'); ?>
    <span>/ <a href="<?php echo e(route('admin.recruiter-services.index')); ?>">Services pour Recruteurs</a> / <?php echo e($isEdit ? 'Modifier' : 'Créer'); ?></span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<form action="<?php echo e($isEdit ? route('admin.recruiter-services.update', $service->id) : route('admin.recruiter-services.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <div class="card" style="margin-top: 1.5rem;">
                <div class="card-body" style="display: flex; gap: 0.75rem;">
                    ...
                    <a href="<?php echo e(route('admin.recruiter-services.index')); ?>" class="btn btn-secondary">Annuler</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookpro/Desktop/Developments/INSAM-DEV/E-Emploie-Backend/estuaire-emploie-backend/resources/views/admin/monetization/recruiter-services/form.blade.php ENDPATH**/ ?>