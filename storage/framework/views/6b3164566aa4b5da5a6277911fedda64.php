...
<body>
    <div class="container">
        ...
        <div class="amount-box">
            ...
            <div class="amount"><?php echo e($amount); ?> <?php echo e($currency); ?></div>
        </div>

        <div class="payment-details">
            <div class="detail-row">
                <span class="detail-label">Transaction #</span>
                <span class="detail-value"><?php echo e($payment->id); ?></span>
            </div>
            <div class="detail-row">
    ...
    <script>
        ...
        function sendMessageToFlutter() {
            const paymentData = {
                success: true,
                payment_id: <?php echo e($payment->id); ?>,
            ...
            setTimeout(() => {
                ...
                window.location.href = 'flutter://payment-success?payment_id=<?php echo e($payment->id); ?>&amount=<?php echo e($payment->amount); ?>';
            }, 500);
        }
...
<?php /**PATH /var/www/clients/client1/web19/web/estuaire-emploie-backend/resources/views/payment/success.blade.php ENDPATH**/ ?>